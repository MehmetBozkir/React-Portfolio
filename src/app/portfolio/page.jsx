                ...
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <div className="flex justify-end">
                    <Link href={item.link} target="_blank">
                      <button className="p-2 text-sm md:p-4 md:text-md lg:p-8 lg:text-lg bg-white text-gray-600 font-semibold m-4 rounded-full flex">
                        Github <FaGithub className="text-2xl" />
                      </button>
                    </Link>
                    <Link href={item.demo} target="_blank">
                      <button className="p-2 text-sm md:p-4 md:text-md lg:p-8 lg:text-lg bg-white text-gray-600 font-semibold m-4 rounded-full flex">
                        Demo <PiProjectorScreen className="text-2xl" />
                      </button>
                    </Link>
                  </div>
                </div>
